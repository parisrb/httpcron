...
- administration can be done using a webapp, a REST API, or the httpcron-client[https://github.com/parisrb/httpcron-client] gem
...
- install ruby 1.9.2
- install the httpcron gem <tt>gem install httpcron</tt>
- go to the target directory
- create a <tt>config.ru</tt> file to setup the server
